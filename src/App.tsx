...
import { LogEntry, ProcessNode, SecurityModule } from './types';
...
const INITIAL_LOGS: LogEntry[] = [
  {
    ...
    level: 'INFO',
    component: 'launcher',
    message: 'Chimera Launcher initialized (uid=0)',
  },
  {
    id: '2',
    timestamp: '10:00:01',
    level: 'INFO',
    component: 'ns_setup',
    message: 'Unsharing namespaces: NEWUSER NEWNET NEWNS NEWPID',
  },
  {
    id: '3',
    timestamp: '10:00:02',
    level: 'INFO',
    component: 'caps',
    message: 'Dropped capabilities: Effective, Permitted, Inheritable',
  },
  {
    id: '4',
    timestamp: '10:00:02',
    level: 'INFO',
    component: 'seccomp',
    message: 'Filter loaded: 14 syscalls allowed',
  },
  {
    id: '5',
    timestamp: '10:00:03',
    level: 'INFO',
    component: 'launcher',
    message: 'Exec: chimera-browser (sandbox active)',
  },
  {
    id: '6',
    timestamp: '10:00:05',
    level: 'DEBUG',
    component: 'bpf',
    message: 'LSM attached: socket_connect',
  },
];
...
export default function App() {
  ...
  const [resourceData, setResourceData] = useState<Array<{ time: string; cpu: number; memory: number }>>([]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 shadow-lg flex flex-col justify-center items-center text-center">
            <div className="w-32 h-32 rounded-full border-4 border-emerald-500/30 flex items-center justify-center mb-4 relative">
              <div className="absolute inset-0 rounded-full border-t-4 border-emerald-500 animate-spin" aria-hidden />
